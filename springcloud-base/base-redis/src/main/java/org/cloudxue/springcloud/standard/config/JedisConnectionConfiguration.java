...
/**
 * @ClassName JedisConnectionConfiguration
 * @Description 重写org.springframework.boot.autoconfigure.data.redis.JedisConnectionConfiguration
 * @Author xuexiao
 * @Date 2022/3/13 上午8:43
 * @Version 1.0
 **/
@Configuration
